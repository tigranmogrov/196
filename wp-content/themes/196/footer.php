<?php if (!is_404()) { ?>
    <footer class="footer" id="footer">
        <div class="scroll-to-top" data-anchor id="scroll-to-top">
            <button class="scroll-to-top__inner"></button>
            TOPへ
        </div>
        <div class="container">
            <a href="<?= get_site_url(); ?>" class="footer__logo-wrap">
            ...
            <div class="footer__list-wrap">
                <ul class="footer__list">
                    <li class="footer__item">
                        <a href="<?= get_site_url(); ?>/about" class="footer__item-link fourth-title">私たちについて</a>

                        <ul class="footer__sublist">
                            <li class="footer__subitem">
                                <a href="<?= get_site_url(); ?>/about" data-anchor="about-support"
                                   class="footer__subitem-link text">
                                    経営理念
                                </a>
                            </li>
                            <li class="footer__subitem">
                                <a href="<?= get_site_url(); ?>/about" data-anchor="company"
                                   class="footer__subitem-link text">
                                    運営会社概要
                                </a>
                            </li>
                            <li class="footer__subitem">
                                <a href="<?= get_template_directory_uri(); ?>/html/public/images/privacy-policy.pdf" target="_blank" class="footer__subitem-link text">
                                    個人情報保護方針（PDFファイル）
                                </a>
                            </li>
                        </ul>
                ...
                <ul class="footer__list">
                    <li class="footer__item">
                        <a href="<?= get_site_url(); ?>/services" class="footer__item-link fourth-title">取り組み</a>
                    </li>
                    <li class="footer__item mt30">
                        <a href="<?= get_post_type_archive_link('facility') ?>"
                           class="footer__item-link fourth-title">施設紹介</a>
                        <ul class="footer__sublist">
                            <li class="footer__subitem">
                                <a href="<?= get_post_type_archive_link('facility') ?>" data-anchor="estate-5"
                                   class="footer__subitem-link text">
                                    有料老人ホーム
                                </a>
                            </li>
                            <li class="footer__subitem">
                                <a href="<?= get_post_type_archive_link('facility') ?>" data-anchor="estate-4"
                                   class="footer__subitem-link text">
                                    グループホーム
                                </a>
                            </li>
                ...
                <ul class="footer__list">
                    <li class="footer__item">
                        <a href="<?= get_site_url(); ?>/topic" class="footer__item-link fourth-title">お知らせ</a>
                    </li>
                    <li class="footer__item mt30">
                        <a href="<?= get_site_url(); ?>/form" class="footer__item-link fourth-title">
                            お問い合わせ・資料請求
                        </a>
                    </li>
                </ul>
