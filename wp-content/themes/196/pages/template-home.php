...
<div class="app" id="app">
    <div class="top">
        ...
        <div class="top-modal" id="top-modal">
            ...
            <div class="top-modal__body">
                <div class="top-modal__body-inner">

                    <span class="top-modal__body-inner-icon">
                        <img src="<?= get_template_directory_uri(); ?>/html/public/images/top/modal_icon.png"
                             alt="icon">
                    </span>
                    <h3 class="subtitle text-gold text-center third-top-offset">新型コロナウイルス<br class="xmb">感染症情報</h3>

                    <h3 class="fourth-title background text-center third-top-offset">
                        施設見学や面会等、<br>
                        詳細につきましては、各施設にお問い合わ<br class="xmb">せ下さい</h3>
                </div>
                <span class="top-modal__body-cross"></span>
            </div>
        </div>
        <div id="pagepiling">
            <div class="section visual" data-section-name="section1">
                <?php
                if (have_rows('home_slider')) {
                    ?>
                    <div class="visual__slider-wrap">
                            ...
                            <div class="swiper-wrapper">
                                <?php while (have_rows('home_slider')) {
                                    ...
                                    <div class="swiper-slide">
                                        <div class="swiper-slide__img" style="background-image: url('<?= $home_slider_img['url']; ?>')">
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
            ...
            <div class="section map" data-section-name="section3">
                <div class="map__top primary-inner-offset">
                    <div class="container">
                        <p class="text small bold text-white text-center">
                        <span class="map__top-text-icon">
                            <svg width="34" height="21" viewBox="0 0 34 21" fill="none"
                                 xmlns="http://www.w3.org/2000/svg"><path
                                        d="M3.077 20.9c3.6.7 4.6-3.3 2.5-4.1-1-.4-1.3.3-1.5.6-.3.1-1.1-.3-.8-1.4.2-.7.8-1.4 2.2-1.1 1.5.4 2.9 1.4 4.4 2.5 1.5 1.1 3.1 2.1 4.8 2.3.5.1.8.1.8.1s-.3 0-.8-.2c-1.6-.5-2.9-1.8-4.1-3-1.4-1.5-2.7-2.9-4.5-3.7-3.6-1.5-6.6 1.5-6 4.9.2 1.5 1.3 2.7 3 3.1zM22.777 16.5c-1.2 1.3-2.5 2.5-4.1 3-.5.2-.8.2-.8.2s.3 0 .8-.1c1.8-.2 3.3-1.2 4.8-2.3 1.5-1.1 2.9-2.1 4.4-2.5 1.4-.3 2 .4 2.2 1.1.3 1.1-.5 1.5-.8 1.4-.2-.3-.5-1-1.5-.6-2.1.9-1.1 4.9 2.5 4.1 1.7-.4 2.8-1.6 3.1-3.2.6-3.4-2.4-6.4-6-4.9-2 .9-3.2 2.3-4.6 3.8zM7.877 9.3c3.6 2.6 4.5 6.7 7.6 8.2-2.8-2.6-2.6-9.9-7.7-12.8-2.3-1.3-4.2.2-3.2 2.1.6 1.1 1.3 1.1 3.3 2.5zM25.377 9.3c2-1.3 2.7-1.4 3.2-2.5 1-1.9-.9-3.4-3.2-2.1-5.1 2.9-4.8 10.2-7.7 12.8 3.3-1.5 4.2-5.7 7.7-8.2zM16.677 0c-3.3 0-1.6 6.1 0 16.7 1.6-10.6 3.2-16.7 0-16.7z"
                                        fill="#E3AA03"/>
                            </svg>
                        </span>
                            EXCELSIOR AREA MAP
                        </p>
                        <div class="animate-text sideSlide">
                            <h2 class="third-title text-white text-center">
                                <span class="animate-item">お</span><span class="animate-item">近</span><span class="animate-item">く</span><span class="animate-item">の</span><br class="xmb"><span class="animate-item">エ</span><span class="animate-item">ク</span><span class="animate-item">セ</span><span class="animate-item">ル</span><span class="animate-item">シ</span><span class="animate-item">オ</span><span class="animate-item">ー</span><span class="animate-item">ル</span><span class="animate-item">を</span><span class="animate-item">探</span><span class="animate-item">す</span>
                            </h2>
                        </div>
                    </div>

                </div>
                <div class="map__inner" data-animate-duration="1000" data-animate="fade-left">
                    <div class="map__image">
                        <img class="lazy"
                             data-src="<?= get_template_directory_uri(); ?>/html/public/images/top/map_image.png"
                             src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                             alt="image description">
                    </div>
                    <div class="map__mark-wrap nth-1">
									<span class="map__mark-desc">
							エクセルシオール佐原
						</span>
                        <div class="map__mark-inner">
							<span class="map__mark active">
				<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                            cx="14" cy="13.933" rx="11.103" ry="11.051" fill="#fff"/><path
                            d="M14 0a14.034 14.034 0 00-9.9 4.081A13.9 13.9 0 000 13.933C0 25.967 14 38 14 38s14-12.033 14-24.067a13.9 13.9 0 00-4.1-9.852A14.034 14.034 0 0014 0zm0 24.7c-2.14 0-4.231-.631-6.01-1.814a10.778 10.778 0 01-3.985-4.832 10.72 10.72 0 01-.615-6.221A10.75 10.75 0 016.35 6.32a10.834 10.834 0 015.54-2.946 10.866 10.866 0 016.25.612 10.807 10.807 0 014.855 3.966 10.73 10.73 0 01-1.345 13.595A10.844 10.844 0 0114 24.7z"
                            fill="#70BF44"/><path
                            d="M16.163 10.696L14 6.334l-2.163 4.362-4.837.7 3.5 3.394-.826 4.795L14 17.32l4.326 2.264-.826-4.795 3.5-3.395-4.837-.7z"
                            fill="#70BF44"/></svg>
						</span>
                            <div class="map__modal active">

                                <div class="map__modal-header">
                                    <span class="map__modal-caption">有料老人ホーム</span>
                                    <p class="text text-white text-center">エクセルシオール佐原</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_03.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.excelsior-sawara.com/" target="_blank" class="map__modal-link">詳細ページへ </a>

                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="map__mark-wrap nth-2">
                        <div class="map__mark-inner">
						<span class="map__mark">
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                                    cx="14" cy="13.933" rx="11.103" ry="11.051" fill="#fff"/><path
                                    d="M14 0a14.034 14.034 0 00-9.9 4.081A13.9 13.9 0 000 13.933C0 25.967 14 38 14 38s14-12.033 14-24.067a13.9 13.9 0 00-4.1-9.852A14.034 14.034 0 0014 0zm0 24.7c-2.14 0-4.231-.631-6.01-1.814a10.778 10.778 0 01-3.985-4.832 10.72 10.72 0 01-.615-6.221A10.75 10.75 0 016.35 6.32a10.834 10.834 0 015.54-2.946 10.866 10.866 0 016.25.612 10.807 10.807 0 014.855 3.966 10.73 10.73 0 01-1.345 13.595A10.844 10.844 0 0114 24.7z"
                                    fill="#70BF44"/><path
                            ...
                            <div class="map__modal">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">有料老人ホーム</span>
                                    <p class="text text-white text-center">リッチランド豊南郷</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_01.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.richlando.com" target="_blank" class="map__modal-link">
                                        詳細ページへ
                                    </a>
                                </div>
                    ...
                    <div class="map__mark-wrap nth-3">
                        <div class="map__mark-inner">
							<span class="map__mark">
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                                    cx="14" cy="13.933" rx="11.103" ry="11.051" fill="#fff"/><path
                            ...
                            <div class="map__modal">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">有料老人ホーム</span>
                                    <p class="text text-white text-center">エクセルシオール千葉</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_04.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.excelsior-chiba.com" target="_blank" class="map__modal-link">詳細ページへ </a>
                    ...
                    <div class="map__mark-wrap nth-4">
							<span class="map__mark-desc">
						エクセルシオール秦野
						</span>
                        <div class="map__mark-inner">
						...
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                            ...
                            <div class="map__modal bottom">

                                <div class="map__modal-header">
                                    <span class="map__modal-caption">有料老人ホーム</span>
                                    <p class="text text-white text-center">エクセルシオール秦野</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_02.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.excelsior-hadano.com" target="_blank" class="map__modal-link">詳細ページへ </a>

                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="map__mark-wrap nth-5">
                        <div class="map__mark-inner">
							<span class="map__mark">
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                                    cx="14" cy="13.933" rx="11.103" ry="11.051" fill="#fff"/><path
                            ...
                            <div class="map__modal bottom">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">有料老人ホーム</span>
                                    <p class="text text-white text-center">エクセルシオール湘南台</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_05.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.excelsior-shonandai.com" target="_blank"
                                       class="map__modal-link">詳細ページへ </a>
                    ...
                    <div class="map__mark-wrap nth-6">
							<span class="map__mark-desc">
								いきいきの家 二子玉川
						</span>
                        <div class="map__mark-inner">
						...
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                            ...
                            <div class="map__modal">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">グループホーム</span>
                                    <p class="text text-white text-center">いきいきの家 二子玉川</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_09.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.ikiiki-futakotamagawa.com" target="_blank"
                                       class="map__modal-link">詳細ページへ </a>
                    ...
                    <div class="map__mark-wrap nth-7">
                        <div class="map__mark-inner">
							<span class="map__mark">
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                                    cx="14" cy="13.933" rx="11.103" ry="11.051" fill="#fff"/><path
                            ...
                            <div class="map__modal bottom">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">グループホーム</span>
                                    <p class="text text-white text-center">いきいきの家 泉</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_07.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.ikiiki-izumi.com" target="_blank"
                                       class="map__modal-link">詳細ページへ </a>
                                </div>
                    ...
                    <div class="map__mark-wrap nth-8">
								<span class="map__mark-desc">
							いきいきの家 今泉
						</span>
                        <div class="map__mark-inner">
						...
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                            ...
                            <div class="map__modal bottom">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">グループホーム</span>
                                    <p class="text text-white text-center">いきいきの家 今泉</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_08.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.ikiiki-imaizumi.com" target="_blank" class="map__modal-link">詳細ページへ </a>
                                </div>

                            </div>
                        </div>
                    </div>
                    <div class="map__mark-wrap nth-9">
								<span class="map__mark-desc">
								いきいきの家 鴨川
						</span>
                        <div class="map__mark-inner">
						...
						<svg width="28" height="38" viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse
                            ...
                            <div class="map__modal bottom">
                                ...
                                <div class="map__modal-header">
                                    <span class="map__modal-caption">グループホーム</span>
                                    <p class="text text-white text-center">いきいきの家 鴨川</p>
                                </div>
                                <div class="map__modal-body">
                                    <div class="map__modal-image-wrap">
                                        <div class="map__modal-image">
                                            <img class="lazy"
                                                 data-src="<?= get_template_directory_uri(); ?>/html/public/images/facility/facility_img_06.jpg"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                                                 alt="image description">
                                        </div>
                                    </div>
                                    <a href="http://www.ikiiki-kamogawa.com" target="_blank" class="map__modal-link">詳細ページへ </a>
                                </div>
                ...
                <div class="map__modal-wrap"></div>
            </div>

            <div class="section top__cards pattern-bg" data-section-name="section4">
                <div class="container">
                    <ul class="top__list">

                        <?php
                        $img_1 = get_field('img_1');
                        $img_sp_1 = get_field('img_sp_1');
                        ?>
                        <li data-animate-duration="1500" data-animate="fade-up" class="top__item">
                            <a href="<?= get_site_url(); ?>/services" class="top__item-link">
                                <div class="top__item-content">
                                    <div class="top__item-content-desc">
                                        <p class="text small">
                                            Dream plan
                                        </p>
                                        <h3 class="third-title line-img">
                                            夢プラン
                                        </h3>
                                    </div>
                                    <div class="top__item-arrow-wrap" data-animate-duration="1000" data-animate="fade-right">
						<span class="top__item-arrow">
	<svg width="40" height="5" viewBox="0 0 40 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                fill-rule="evenodd" clip-rule="evenodd" d="M33.407 0L40 5H0V3.958h36.949L32.855.854 33.407 0z"
                fill="#70BF44"/></svg>
						</span>
                                    </div>
                                </div>
                                <div class="top__item-image-wrap">
                                    <div class="top__item-image">

                                        <picture>
                                            <source srcset="<?= $img_sp_1['url']; ?>"
                                                    media="(max-width: 767px)">
                                            <source srcset="<?= $img_1['url']; ?>"
                        ...
                        <li data-animate-duration="1500" data-animate="fade-up" class="top__item">
                            <a href="<?= get_site_url(); ?>/services" class="top__item-link">
                                <div class="top__item-content">
                                    ...
                                    <div class="top__item-arrow-wrap" data-animate-duration="1000" data-animate="fade-left">
						<span class="top__item-arrow">
				<svg width="40" height="5" viewBox="0 0 40 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                            fill-rule="evenodd" clip-rule="evenodd"
                            d="M33.407 0L40 5H0V3.958h36.949L32.855.854 33.407 0z" fill="#70BF44"/></svg>
						</span>
                                    </div>
                                </div>
                                <div class="top__item-image-wrap">
                                    <div class="top__item-image">
                                        ...
                                        <picture>
                                            <source srcset="<?= $img_sp_2['url']; ?>"
                                                    media="(max-width: 767px)">
                                            <source srcset="<?= $img_2['url']; ?>"
                                                    media="(min-width: 768px)">
                                            <img class="lazy"
                                                 data-src="<?= $img_2['url']; ?>"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
	...
	<svg width="40" height="5" viewBox="0 0 40 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                ...
                fill="#70BF44"/></svg>
                                ...
                                <div class="top__item-image-wrap">
                                    <div class="top__item-image">
                                        <picture>
                                            <source srcset="<?= $img_sp_3['url']; ?>"
                                                    media="(max-width: 767px)">
                                            <source srcset="<?= $img_3['url']; ?>"
                                                    media="(min-width: 768px)">
                                            <img class="lazy"
                                                 data-src="<?= $img_3['url']; ?>"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
	...
	<svg width="40" height="5" viewBox="0 0 40 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path
                ...
                fill="#70BF44"/></svg>
                                ...
                                <div class="top__item-image-wrap">
                                    <div class="top__item-image">
                                        <picture>
                                            <source srcset="<?= $img_sp_4['url']; ?>"
                                                    media="(max-width: 767px)">
                                            <source srcset="<?= $img_4['url']; ?>"
                                                    media="(min-width: 768px)">
                                            <img class="lazy"
                                                 data-src="<?= $img_4['url']; ?>"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
                        ...
                        <?php
                        $img_5 = get_field('img_5');
                        $img_sp_5 = get_field('img_sp_5');
                        ?>
                        <li data-animate-duration="1500" data-animate="fade-up" class="top__item">
                            <a href="<?= get_site_url(); ?>/services" class="top__item-link">
                                <div class="top__item-content">
                                    ...
                                    <div class="top__item-arrow-wrap" data-animate-duration="1000" data-animate="fade-right">
						<span class="top__item-arrow">
<svg width="40" height="5" viewBox="0 0 40 5" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd"
                                                                                                   clip-rule="evenodd"
                                                                                                   d="M33.407 0L40 5H0V3.958h36.949L32.855.854 33.407 0z"
                                                                                                   fill="#70BF44"/></svg>
						</span>
                                    </div>
                                </div>
                                <div class="top__item-image-wrap">
                                    <div class="top__item-image">
                                        <picture>
                                            <source srcset="<?= $img_sp_5['url']; ?>"
                                                    media="(max-width: 767px)">
                                            <source srcset="<?= $img_5['url']; ?>"
                                                    media="(min-width: 768px)">
                                            <img class="lazy"
                                                 data-src="<?= $img_5['url']; ?>"
                                                 src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"
            ...
            <section class="section notice dark-grey-bg" data-section-name="section5">
                <div class="container">
                    <?php
                    ...
                    if ($query_post->have_posts()) { ?>
                        <div class="title-wrap">
                            <p class="text small text-white text-center">TOPICS</p>
                            <div class="animate-text sideSlide">
                            <h3 class="third-title text-center text-white line-img">
                                <span class="animate-item">お</span><span class="animate-item">知</span><span class="animate-item">ら</span><span class="animate-item">せ</span>
                            </h3>
                            </div>
                        </div>
                                ...
                                <li class="notice__item">
                                    <?php if ($news_date) { ?>
                                        <div class="notice__item-date">
                                            <p class="text"><?= $news_date; ?></p>
                                        </div>
                                    <?php }
                                    if ($news_title) {
                                        ?>
                                        <div class="notice__item-info">
                                            <a href="<?= $news_url; ?>" class="notice__item-info-link text">
                                                <?= $news_title; ?>
                                            </a>
                                        </div>
                                    <?php } ?>
